...
public final class Mat4 extends AbstractMat {
	...
	public Mat4 translate2(final Vec3 translation) {
		Vec4 v0 = new Vec4(1,0,0,translation.x);
		Vec4 v1 = new Vec4(0,1,0,translation.y);
		Vec4 v2 = new Vec4(0,0,1,translation.z);
		Vec4 v3 = new Vec4(0,0,0,1);
		return new Mat4(v0,v1,v2,v3).transpose();
	}
